...
public class BankServiceClassImpl implements BankService {
	...
	@Override
	public void setQueryStatus(String queryId, String newStatus) throws IBSException, SQLException, IOException {
	...
	private void upgradeCC(String queryId) throws IBSException, SQLException, IOException {
		bankDao.actionUpgradeCC(queryId);
	}

	private void upgradeDC(String queryId) throws SQLException, IOException {
		bankDao.actionUpgradeDC(queryId);
	}

	private void blockCC(String queryId) throws SQLException, IOException {
		String status = "Blocked";
		bankDao.actionBlockCC(queryId, status);
	}

	private void blockDC(String queryId) throws SQLException, IOException {
		String status = "Blocked";
